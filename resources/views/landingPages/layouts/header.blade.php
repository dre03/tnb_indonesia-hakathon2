...
<body>
  ...
  <header id="header" class="fixed-top ">
    <div class="container d-flex align-items-center">
      <h1 class="logo me-auto"><a href="index.html"><img src="{{ asset('assetsFe/img/hero-image.png')}}" alt="Logo" class="img-fluid"></a></h1>
      <nav id="navbar" class="navbar">
        <ul>
          <li><a class="nav-link scrollto {{ Request::is('home') ? 'active' : '' }}" href="/home">Home</a></li>
          <li><a class="nav-link scrollto {{ Request::is('about') ? 'active' : '' }}" href="/home#about">About</a></li>
          <li><a class="nav-link scrollto {{ Request::is('services') ? 'active' : '' }}" href="/home#services">Services</a></li>
          <li><a class="nav-link scrollto {{ Request::is('team') ? 'active' : '' }}" href="/home#team">Speakers</a></li>
          <li><a class="nav-link scrollto {{ Request::is('event*') ? 'active' : '' }}" href="#event">Event</a></li>
          <li><a class="nav-link scrollto {{ Request::is('contact') ? 'active' : '' }}" href="/home#contact">Contact</a></li>
